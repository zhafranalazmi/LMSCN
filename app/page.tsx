  ...
  return (
    <main className="min-h-screen flex flex-col">
      <header className="flex items-center justify-between px-8 py-6">
        <span className="font-display font-bold text-lg text-plum-700">
          SMK Citra Negara
        </span>
        <Link
          href="/login"
          className="rounded-full bg-plum-700 text-white px-5 py-2 text-sm font-medium hover:bg-plum-900 transition-colors"
        >
          Masuk
        </Link>
      </header>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6">
        <span className="uppercase tracking-widest text-xs text-brand-600 font-semibold mb-3">
        ...
        <Link
          href="/login"
          className="mt-8 rounded-full bg-brand-500 text-white px-8 py-3 font-medium hover:bg-brand-600 transition-colors"
        >
          Masuk ke akun kamu
        </Link>
      </section>
